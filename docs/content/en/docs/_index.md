...
{{< cards cols="2" >}}
  {{< card link="getting-started" title="Getting Started" subtitle="Install the library, write your first evaluation, learn about compiling and caching expressions, and explore the convenience functions." >}}
  {{< card link="concepts" title="Core Concepts" subtitle="Understand the FHIRPath type system, collections and empty propagation, operators and three-valued logic, and environment variables." >}}
{{< /cards >}}
